...
if __name__ == '__main__':
  ...
  print('\nGot queue...\n', q)
  r = send_message(q, 'Hello, world!')
  print('\nGot response...\n', r)
  custom_attributes = {'Author': {'StringValue': 'alex-walczak', 'DataType': 'String'}}
  r = send_message(q, 'It is I.', custom_attributes)
  print('\nGot response 2...\n', r)
  message_batch = generate_message_batch(10)
  print('\nSending message batch...\n', r)
  r = send_messages(q, message_batch)
  print('\nFailures...')
  print(r.get('Failed'))
  print('\nProcessing...')
